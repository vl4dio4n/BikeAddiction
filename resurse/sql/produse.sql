...
INSERT INTO produse(nume, descriere, pret, an_fabricatie, categ_produse, specificatii, imagine, autor_anunt, producator, livrare, telefon, email, user_id) VALUES
...
21995.00, 2021, 'biciclete', '{"full suspension","carbon","Trail/All mountain"}', 'poze_uploadate/vl4dio4n/produse/produs_1.png', 'vl4dio4n', 'Cannondale', False, '07********', 'bikeaddiction2@gmail.com', 1);
...
3399, 2020, 'biciclete', '{"hardtail","aluminiu","Cross Country"}', 'poze_uploadate/vl4dio4n/produse/produs_2.png', 'vl4dio4n', 'Specialized', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
2775.00, 2021, 'biciclete', '{"hardtail","aluminiu","Cross Country"}', 'poze_uploadate/vl4dio4n/produse/produs_3.png', 'vl4dio4n', 'Cube', False, '07********', 'bikeaddiction2@gmail.com', 1),
...
2535.00, 2020, 'biciclete', '{"hardtail","aluminiu","Cross Country"}', 'poze_uploadate/vl4dio4n/produse/produs_4.png', 'vl4dio4n', 'Cube', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
20849.00, 2022, 'biciclete', '{"full suspension","carbon","Trail/All mountain"}', 'poze_uploadate/vl4dio4n/produse/produs_5.png', 'vl4dio4n', 'Specialized', False, '07********', 'bikeaddiction2@gmail.com', 1),

('BICICLETA CANNONDALE SUPERSIX EVO', 'IA-TI ZBORUL CU CEA MAI RAPIDA SI USOARA BICICLETA DE LA CANNONDALE',
32995.00, 2022, 'biciclete', '{"fix","carbon","Gravel"}', 'poze_uploadate/vl4dio4n/produse/produs_6.png', 'vl4dio4n', 'Cannondale', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
21995.00, 2022, 'biciclete', '{"hardtail","carbon","Gravel"}', 'poze_uploadate/vl4dio4n/produse/produs_7.png', 'vl4dio4n', 'Cannondale', False, '07********', 'bikeaddiction2@gmail.com', 1),

('BICICLETA CROSS TRAFFIC URBAN', 'Ghid marime',
4749.00, 2020, 'biciclete', '{"hardtail","aluminiu","Urban"}', 'poze_uploadate/vl4dio4n/produse/produs_8.png', 'vl4dio4n', 'Cross', True, '07********', 'bikeaddiction2@gmail.com', 1),

('BICICLETA CROSS ARENA', 'Ghid marime',
2549.00, 2020, 'biciclete', '{"hardtail","aluminiu","Urban"}', 'poze_uploadate/vl4dio4n/produse/produs_9.png', 'vl4dio4n', 'Cross', False, '07********', 'bikeaddiction2@gmail.com', 1),
...
2599.00, 2021, 'biciclete', '{"hardtail","aluminiu","Cross Country"}', 'poze_uploadate/vl4dio4n/produse/produs_10.png', 'vl4dio4n', 'Cube', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
1995.00, 2021, 'biciclete', '{"hardtail","aluminiu","Cross Country"}', 'poze_uploadate/vl4dio4n/produse/produs_11.png', 'vl4dio4n', 'Cube', False, '07********', 'bikeaddiction2@gmail.com', 1),
...
13855.00, 2021, 'biciclete', '{"hardtail","aluminiu","Cross Country"}', 'poze_uploadate/vl4dio4n/produse/produs_12.png', 'vl4dio4n', 'Cube', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
16199.00, 2020, 'biciclete', '{"hardtail","aluminiu","Cross Country"}', 'poze_uploadate/vl4dio4n/produse/produs_13.png', 'vl4dio4n', 'Cube', False, '07********', 'bikeaddiction2@gmail.com', 1),
...
1845.00, 2022, 'biciclete', '{"hardtail","otel","bmx"}', 'poze_uploadate/vl4dio4n/produse/produs_14.png', 'vl4dio4n', 'Subrosa', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
1999.00, 2021, 'biciclete', '{"hardtail","otel","bmx"}', 'poze_uploadate/vl4dio4n/produse/produs_15.png', 'vl4dio4n', 'Subrosa', False, '07********', 'bikeaddiction2@gmail.com', 1);

INSERT INTO produse(nume, descriere, pret, an_fabricatie, categ_produse, specificatii, imagine, autor_anunt, producator, livrare, telefon, email, user_id) VALUES
('PINIOANE SunRace', '8-Speed, Lightweight Design',
83.00, 2021, 'piese', '{"8 pinioane","caseta"}', 'poze_uploadate/biker1/produse/produs_1.png', 'biker1', 'Shimano', True, '07********', 'bikeaddiction2@gmail.com', 1),

('CASSETTE SPROCKET', '10-Speed, Lightweight Design',
189.00, 2020, 'piese', '{"10 pinioane","caseta"}', 'poze_uploadate/biker1/produse/produs_2.png', 'biker1', 'Deore', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
325.00, 2020, 'accesorii', '{"650mm", "otel", "portocaliu"}', 'poze_uploadate/biker1/produse/produs_3.png', 'biker1', 'SKS', False, '07********', 'bikeaddiction2@gmail.com', 1),
...
179.00, 2022, 'accesorii', '{"1000mm", "metal","galben"}', 'poze_uploadate/biker1/produse/produs_4.png', 'biker1', 'SKS', True, '07********', 'bikeaddiction2@gmail.com', 1),
...
199.00, 2021, 'echipamente', '{"rosu", "M"}', 'poze_uploadate/biker1/produse/produs_5.png', 'biker1', 'Fox', False, '07********', 'bikeaddiction2@gmail.com', 1),

('MANUSI SPECIALIZED SOFTSHELL', 'Tehnologie 100g Primaloft insulation',
249.00, 2020, 'echipamente', '{"negru", "XXL"}', 'poze_uploadate/biker1/produse/produs_6.png', 'biker1', 'Specialized', True, '07********', 'bikeaddiction2@gmail.com', 1),

('PANTOFI CICLISM SPECIALIZED 2FO ROOST', 'Pantofi foarte smecheri',
548.99, 2015, 'echipamente', '{"negru", "40"}', 'poze_uploadate/biker1/produse/produs_7.png', 'biker1', 'Specialized', False, '07********', 'bikeaddiction2@gmail.com', 1);